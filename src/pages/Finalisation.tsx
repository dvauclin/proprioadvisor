...
const Finalisation = () => {
  ...
  return <div className="py-12 bg-gradient-to-b from-white to-gray-50">
      <Head>
        <title>Finalisation de votre inscription | Proprioadvisor</title>
        <meta name="description" content="Prenez rendez-vous pour finaliser votre partenariat avec Proprioadvisor" />
      </Head>
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            <div className="mx-auto w-16 h-16 mb-4 text-green-500 flex items-center justify-center">
              <CheckCircle size={64} />
            </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <h2 className="text-xl font-semibold mb-4 text-center">Planifiez votre rendez-vous</h2>
            <div style={{
            width: '100%',
            height: '600px',
            overflow: 'scroll'

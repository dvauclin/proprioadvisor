...
import { calculateEffectiveTotalPoints } from "@/utils/subscriptionPointsCalculator";
...
const Admin = () => {
  ...
  const handleToggleBacklink = async (subscriptionId: string, newBacklinkValue: boolean) => {
    ...
    try {
      ...
      // Calculate effective total points using the utility function
      const effectiveTotalPoints = calculateEffectiveTotalPoints({

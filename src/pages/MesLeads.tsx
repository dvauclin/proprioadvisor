        ...
        <div className="mb-8">
          ...
          <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-blue-800 text-base">
              x <strong>Astuce :</strong> Marquez vos leads comme "vus" le plus rapidement possible pour faire partie des conciergeries les plus réactives et obtenir un boost de visibilité !
            </p>
          </div>
        </div>

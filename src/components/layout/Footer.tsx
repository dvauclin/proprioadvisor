        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <section>
            ...
            <nav aria-label="Navigation du pied de page" className="flex flex-col space-y-3 text-sm">
              ...
              <Link href="/alternatives" className="text-gray-600 hover:text-primary hover:bg-primary/5 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 rounded-full px-2 py-1 transition-colors">ProprioAdvisor et ses alternatives</Link>

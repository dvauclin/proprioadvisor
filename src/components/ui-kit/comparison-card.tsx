...
const ComparisonCard: React.FC<ComparisonCardProps> = ({ 
  ...
  // Vérifier si la conciergerie est non recommandée : score effectif = max(points souscription, score manuel)
  const isNonRecommande = Math.max(subscription?.total_points || 0, conciergerie?.scoreManuel ?? 0) < 1;
